    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-center mb-4">
        <a
          ...
          className="object-cover h-12 w-12 mx-3 cursor-pointer transition-colors duration-300 hover:fill-[#f39c12]"
          aria-label="GitHub"
        >
          <svg
            role="img"
        ...
        <a
          href="https://www.linkedin.com/in/michaelwiciak/"
          target="_blank"
          rel="noopener noreferrer"
          className="object-cover h-12 w-12 mx-3 cursor-pointer transition-colors duration-300 hover:fill-[#f39c12]"
          aria-label="LinkedIn"
        ...
        <a
          href="https://www.instagram.com/wiciakmichael/"
          target="_blank"
          rel="noopener noreferrer"
          className="object-cover h-12 w-12 mx-3 cursor-pointer transition-colors duration-300 hover:fill-[#f39c12]"
