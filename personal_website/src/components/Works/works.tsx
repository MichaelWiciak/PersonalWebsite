...
const Works: React.FC = () => {
  ...
  const redirectpgm = () => {
    window.location.href =
      "https://github.com/MichaelWiciak/PGMFileManipulatorUtility";
  };
  const redirectJack = () => {
  ...
  return (
    <section id="works">
      ...
      <span className="worksDesc">
        These are screenshots of some of the projects I worked on. They will
        take you to an active deployment or if not available, to the GitHub repo
      ...
      <div className="worksImages">
        <img
          ...
          alt=""
          className="worksImg"
          onClick={redirectTimetableX}
        />
        <img
          src={stanford}
          alt=""
          className="worksImg"
          onClick={redirectStanford}
        />
        <img
          src={sportcentre}
          alt=""
          className="worksImg"
          onClick={redirectSports}
        />
        <img
          src={videoPlayer}
          alt=""
        ...
        <img
          ...
          alt=""
          className="worksImg"
          onClick={redirectJack}
        />
      </div>
      <button className="worksBtn" onClick={redirectGitHub}>
        See More
      </button>
    </section>
  );
